...
class HomeworkTaskTimingService
{
     ...
     */
    public function evaluate(HomeworkTask $task): array
    {
    ...
    public function requiredReasonStage(HomeworkTask $task, string $nextStatus): ?string
    {
