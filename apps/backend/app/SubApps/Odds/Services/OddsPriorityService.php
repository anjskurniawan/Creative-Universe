...
class OddsPriorityService
{
    public function score(Task $task, ?DesignerProfile $profile = null): float
    {
        ...
        $matrixScore = match ($matrix) {
            'urgent', 'quadrant_1', 'quadrant 1', 'quadran i', 'quadran 1', 'q1' => 80,
            'high', 'quadrant_2', 'quadrant 2', 'quadran ii', 'quadran 2', 'q2' => 60,
            'medium', 'quadrant_3', 'quadrant 3', 'quadran iii', 'quadran 3', 'q3' => 40,
            'low', 'normal', 'quadrant_4', 'quadrant 4', 'quadran iv', 'quadran 4', 'q4' => 25,
            default => 25,
        };
