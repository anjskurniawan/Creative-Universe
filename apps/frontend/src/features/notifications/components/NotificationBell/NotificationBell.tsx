...
import type { CommunicationBellProps } from "@/hooks/communication-actions";
...
export function NotificationBell({ userId, variant = "light", renderTrigger, panelClassName = "" }: CommunicationBellProps) {
