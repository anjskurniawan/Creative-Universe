...
import FileUploadDropzone, { UploadedFile } from './FileUploadDropzone/FileUploadDropzone';
...
export function TaskFormModal({ isOpen, onClose }: TaskFormModalProps) {
  ...
  return (
    <div className="cu-style fixed inset-0 z-[200] flex items-start justify-center bg-gray-900/40 p-0 backdrop-blur-md sm:items-center sm:p-4">
