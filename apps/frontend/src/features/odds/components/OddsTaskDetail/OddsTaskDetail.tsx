...
import { OddsRichTextEditor, RichTextViewer, stripRichText } from "@/features/odds/components/OddsRichTextEditor/OddsRichTextEditor";
import { TaskFeedbackToast, TaskDiscussionPanel } from "@/features/odds/components/OddsTaskCard";
...
import { OddsBriefViewer, StandardBriefPreview, isTableBriefTask } from "@/features/odds/components/BriefDetails";
import { shouldHideOddsCancelSkipMenus } from "@/features/odds/utils/menu-visibility";
import { DetailActionButton as ActionButton, DetailInfoRow as InfoRow, DetailShellMessage as ShellMessage, DetailSkeleton as TaskDetailSkeleton } from "@/features/odds/components/OddsTaskDetail/DetailUi/DetailUi";
import { OddsTaskAuditPanel } from "@/features/odds/components/OddsTaskDetail/OddsTaskAuditPanel/OddsTaskAuditPanel";
import { OddsTaskOutputPanel } from "@/features/odds/components/OddsTaskDetail/OddsTaskOutputPanel/OddsTaskOutputPanel";
import { OddsTaskHistoryPanel } from "@/features/odds/components/OddsTaskDetail/OddsTaskHistoryPanel/OddsTaskHistoryPanel";
import { OddsTaskActionsPanel } from "@/features/odds/components/OddsTaskDetail/OddsTaskActionsPanel/OddsTaskActionsPanel";
import { OddsTaskRevisionPanel } from "@/features/odds/components/OddsTaskDetail/OddsTaskRevisionPanel/OddsTaskRevisionPanel";
import { GroupButton } from "@/features/odds/components/OddsTaskDetail/GroupButton/GroupButton";
import { ClientTableBriefEditor as TaskDetailClientTableBriefEditor } from "@/features/odds/components/OddsTaskDetail/ClientTableBriefEditor/ClientTableBriefEditor";
import { QaComponentBoundary } from "@/features/odds/components/OddsTaskDetail/QaComponentBoundary/QaComponentBoundary";
import { TaskHeader } from "@/features/odds/components/OddsTaskDetail/TaskHeader/TaskHeader";
import { TaskTimer } from "@/features/odds/components/OddsTaskDetail/TaskTimer/TaskTimer";
import { RevisionBrief } from "@/features/odds/components/OddsTaskDetail/RevisionBrief/RevisionBrief";
import { RevisionMessage } from "@/features/odds/components/OddsTaskDetail/RevisionMessage/RevisionMessage";
import { TaskDetailTabs, type TaskDetailTab } from "@/features/odds/components/OddsTaskDetail/TaskDetailTabs/TaskDetailTabs";
import { useOddsTaskDetailPreview } from "@/features/odds/components/OddsTaskDetail/OddsTaskDetailPreviewContext/OddsTaskDetailPreviewContext";
...
function DetailContent() {
  ...
  return (
    <div className="cu-style flex w-full h-full min-h-0 flex-col gap-4 lg:gap-4 overflow-hidden">
      <TaskFeedbackToast
