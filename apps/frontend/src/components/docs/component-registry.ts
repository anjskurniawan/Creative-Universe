...
export const COMPONENT_DOCUMENTATION = [
  ...
  { name: "ReportHeader", label: "Report Header", slug: "components/creative-report-header", category: "ui", status: "stable", application: "creative-report" },
  ...
  { name: "ReportToolbar", label: "Report Toolbar", slug: "components/creative-report-toolbar", category: "ui", status: "stable", application: "creative-report" },
