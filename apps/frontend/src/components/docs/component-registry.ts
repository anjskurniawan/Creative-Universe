...
export const COMPONENT_DOCUMENTATION = [
  ...
  { name: "OddsTaskCardAdmin", label: "Admin", slug: "components/odds-task-card-admin", category: "odds", status: "review", application: "odds", subGroup: "Task Cards" },
  { name: "OddsTaskCardClient", label: "Client", slug: "components/odds-task-card-client", category: "odds", status: "review", application: "odds", subGroup: "Task Cards" },
  { name: "OddsTaskCardDesigner", label: "Designer", slug: "components/odds-task-card-designer", category: "odds", status: "review", application: "odds", subGroup: "Task Cards" },
