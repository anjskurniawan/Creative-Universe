...
import { RequestFormatStep } from "@/features/odds/components/request-builder/steps/request-format-step";
import { createRequestBuilderTheme } from "@/features/odds/components/request-builder/theme";

function MockRequestFormatWrapper() {
  const theme = createRequestBuilderTheme("light");
  return (
    <div className="w-full max-w-[1000px] bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden flex flex-col min-h-[400px]">
      <RequestFormatStep theme={theme} />
    </div>
  );
}

export function OddsRequestFormatStepDocumentation() {
  ...
  return (
    <div className="doc-example-container">
      ...
      <header className="doc-hero">
        ...
        <h1 className="doc-hero-title">RequestFormatStep</h1>
        <p className="doc-hero-subtitle">
          Interactive documentation for the ODDS RequestFormatStep component.
        </p>
      ...
      <section className="doc-section">
        <div className="doc-section-header">
          ...
          <p className="doc-section-desc">Live preview of RequestFormatStep.</p>
        </div>
      ...
      <section className="doc-section">
        ...
        <div className="doc-install-card mt-4">
          ...
          <div className="doc-install-body text-cu-muted"><code>src/features/odds/components/request-builder/steps/request-format-step.tsx</code></div>
        </div>
      </section>
      ...
      <section className="doc-section">
        ...
        <div className="doc-code-block-container">
          <div className="doc-code-block-header">
            <span className="doc-code-filename">features/odds/components/request-builder/steps/request-format-step.tsx</span>
