...
export function OddsLoadoutRowDocumentation() {
  ...
  return (
    <div className="doc-example-container">
      ...
      <header className="doc-hero">
        ...
        <h1 className="doc-hero-title">LoadoutRow</h1>
        <p className="doc-hero-subtitle">
          Interactive documentation for the ODDS LoadoutRow retro component.
        </p>
      ...
      <section className="doc-section">
        <div className="doc-section-header">
          ...
          <p className="doc-section-desc">Live preview of LoadoutRow.</p>
        </div>
              ...
              <div className="doc-preview-area !p-4 !bg-[#dfe2d3] border-[3px] border-[#24252b] shadow-[inset_0_0_0_3px_#b5b9ad] w-full max-w-[850px] font-mono">
                ...
                */}
                <div className="p-8 text-center border-2 border-[#24252b] bg-[#eceee6] text-[#24252b]">
                  <h3 className="text-xl font-black uppercase">LoadoutRow</h3>
      ...
      <section className="doc-section">
        ...
        <div className="doc-install-card mt-4">
          ...
          <div className="doc-install-body text-cu-muted"><code>apps/frontend/src/components/odds/retro/loadout-row.tsx</code></div>
        </div>
      </section>
      ...
      <section className="doc-section">
        ...
        <div className="doc-code-block-container">
          <div className="doc-code-block-header">
            <span className="doc-code-filename">components/odds/retro/loadout-row.tsx</span>
