...
export function OddsTaskCardDocumentation({ view }: { view?: OddsTaskCardView }) {
    ...
    return (
      <div className="doc-example-container">
        <header className="doc-hero">
          <div className="doc-hero-badge">ODDS / Task Card</div>
          <h1 className="doc-hero-title">ODDS Task Card - {viewLabels[view]}</h1>
        ...
        <section className="doc-section">
          ...
          <div className="doc-install-card mt-4">
            ...
            <div className="doc-install-body text-cu-muted">
              <code>apps/frontend/src/components/odds/odds-task-card.tsx</code>
            </div>
          </div>
        </section>
        <section className="doc-section">
  ...
  return (
    <div className="doc-example-container">
      <header className="doc-hero">
        <div className="doc-hero-badge">ODDS</div>
        <h1 className="doc-hero-title">ODDS Task Card</h1>
        <p className="doc-hero-subtitle">
      ...
      <section className="doc-section">
        <div className="doc-section-header">
          <h2 className="doc-section-title">Views</h2>
        </div>
        <div className="doc-grid mt-4">
          {(["admin", "client", "designer"] as OddsTaskCardView[]).map((item) => (
            <a key={item} href={`?section=components/odds-task-card-${item}`} className="doc-grid-item" style={{ textDecoration: 'none', display: 'block', padding: '1.5rem', transition: 'all 0.2s ease' }}>
              <h3 style={{ margin: '0 0 0.5rem', fontSize: '1rem', fontWeight: 700, color: 'hsl(var(--foreground))' }}>{viewLabels[item]}</h3>
              <p style={{ margin: 0, fontSize: '0.875rem', color: 'hsl(var(--muted-foreground))', lineHeight: 1.5 }}>Task card untuk role {viewLabels[item]}.</p>
            </a>
          ))}
        </div>
      </section>
