...
export default function Sidebar({
  ...
  return (
    <aside
      className={`flex shrink-0 flex-col justify-between border-r border-black/[0.045] bg-white/40 py-5 transition-[width] duration-200 ${expanded ? "w-56 px-3" : "w-16 items-center px-4"} ${className}`}
