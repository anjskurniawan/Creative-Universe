...
import { SidebarUtilityActions } from "@/components/navigation/SidebarUtilityActions/SidebarUtilityActions";
import { useAuth } from "@/hooks/auth";

export type SideMenuVariant = "Collaps" | "Expand";
export type { SideMenuIconVariant } from "@/components/navigation/sidemenu";
export type { SideMenuMenuModel, SideMenuMenuStatus } from "@/components/navigation/sidemenu";
export type { SideMenuAvatarVariant } from "@/components/navigation/sidemenu";
