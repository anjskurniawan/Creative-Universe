...
export default function DeveloperLogLayout({ children }: { children: ReactNode }) {
  return (
    <div className="h-screen w-screen overflow-hidden bg-[radial-gradient(circle_at_8%_6%,#00e7ef_0,transparent_25%),radial-gradient(circle_at_95%_90%,#00a4ff_0,transparent_31%),linear-gradient(135deg,#00a4ff_0%,#000675_44%,#04044a_100%)]">
      <Container
        viewport="Desktop"
        menuTitle="Agent Work Log"
        breadcrumbItems={["Developer", "Log"]}
        contentProps={{
          className: "w-full h-full flex flex-col overflow-y-auto rounded-[16px] bg-[#f3fbff] text-cu-ink shadow-[0px_14px_42px_0px_rgba(44,42,39,0.16)]",
          hideSidebar: true,
        }}
      >
        {children}
