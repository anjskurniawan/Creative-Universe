...
export default function DeveloperTokenPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-5 py-5 pb-12 lg:px-8 lg:py-8">
      ...
      <p className="mt-5 text-center text-[10px] text-cu-muted">Sumber token aktif: <code>apps/frontend/src/app/globals.css</code> dan component primitives di <code>src/components/ui</code>.</p>
    </main>
  );
}
