    ...
    <>
      {!isAuthenticated && (
        <div className="block md:hidden">
          <GuestMobileLandingPage />
        </div>
      )}

      <div
        data-interactive-hero
        className={`relative isolate min-h-screen flex-col overflow-hidden bg-cu-surface font-sans text-cu-ink antialiased ${
...
function GuestMobileLandingPage() {
  ...
  return (
    <div className="relative isolate min-h-[100dvh] overflow-hidden bg-black font-sans text-white antialiased">
      ...
      <nav className="relative z-30 h-[72px] bg-black">
        <div className="flex h-full w-full items-center px-4">
          <Link href="/" aria-label="Creative Universe" className="inline-flex size-9 items-center justify-center">
            <Image
              src={`${LANDING_ASSET_PATH}/logo-navbar.svg`}
              alt=""
              width={36}
              height={39}
              priority
