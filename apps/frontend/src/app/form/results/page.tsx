...
export default function FormResultsPage() {
  ...
  const removeFeedback = async (id: number) => {
    if (!window.confirm("Hapus feedback ini? Data yang sudah dihapus tidak dapat dikembalikan.")) return;
    setDeletingId(id);
    try {
      await apiFetch(`/internal-client-feedback/${id}`, { method: "DELETE" });
