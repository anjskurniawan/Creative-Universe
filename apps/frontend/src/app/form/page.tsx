...
export default function FormPage() {
  ...
  const submit = async (event?: FormEvent) => {
    ...
    try {
      await apiFetch("/internal-client-feedback", { method: "POST", body: JSON.stringify({ ...values, name: values.name.trim(), division: values.division.trim(), satisfaction: Number(values.satisfaction) }) });
      setSubmitted(true);
    } catch (cause) {
