...
const CELEBRATION_MUSIC_SOURCE = "/audio/sfx.wav";
...
export default function FormPage() {
  ...
  useEffect(() => {
    if (values.satisfaction !== 10 || !CELEBRATION_MUSIC_SOURCE || !audioRef.current) return;
