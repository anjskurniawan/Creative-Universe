...
export function PerformanceMetricCard({ label, value, unit = "task", increase, previous = 0, icon = "check_circle", iconColor = "#e4e4e4", decimals = 0, theme = "dark", compact = false }: PerformanceMetricCardProps) {
  ...
  return (
    <article className={`cu-style performance-metric-card relative flex ${compact ? "h-[118px]" : "h-[139px]"} w-full min-w-0 flex-col gap-1 rounded-2xl p-2 ${retro ? "border-2 border-[#24252b] bg-[#eceee6] shadow-[inset_0_0_0_2px_#c9ccc0]" : light ? "border border-white/80 bg-white/90 shadow-[0_5px_14px_rgba(44,42,39,0.06)]" : "border border-white/[0.05] bg-[#171717] shadow-[0_5px_14px_rgba(0,0,0,0.24)]"}`} data-node-id="32:383">
