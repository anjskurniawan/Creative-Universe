...
export function AppTitle({ title, subtitle, icon }: AppTitleProps) {
  return (
    <div className="cu-style w-full flex-1 min-h-[70vh] flex flex-col items-center justify-center text-center p-6 md:p-12 relative overflow-hidden rounded-2xl bg-white/40 backdrop-blur-md border border-white/60 shadow-[0_8px_32px_0_rgba(109,70,235,0.03)] transition-all duration-300">
