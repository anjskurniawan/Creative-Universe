...
import DetailCard from "@/app/creative-report/creative-agent/_components/DetailCard/DetailCard";
import ProfileCard from "@/components/layout/profile/Card/Card";
import { resolveStorageUrl } from "@/core/api/client";
import { useCreativeAgent, displayCreativeRole } from "@/app/creative-report/creative-agent/use-creative-agent";
...
export default function CreativeReportCreativeAgentPage() {
  ...
  return (
    <section ref={detailCardRef} className="cu-style flex w-full scroll-mt-4 flex-col gap-4">
      <DetailCard
        name={member.name}
