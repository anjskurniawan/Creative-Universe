  ...
  return (
    <header className="flex min-h-[45px] items-center justify-between gap-6 pb-4">
      ...
      <div className="flex gap-2">
        <button type="button" onClick={(event) => (event.currentTarget.querySelector('input[type="month"]') as HTMLInputElement | null)?.showPicker()} className={`relative flex items-center gap-2 rounded-lg border p-2 text-sm font-medium leading-4 ${theme === "dark" ? "border-[#b0ff5e]/30 bg-[#121916] text-[#f1f1f1]" : theme === "retro" ? "border-2 border-[#24252b] bg-[#eceee6] text-[#24252b] shadow-[0_2px_0_#24252b]" : "border-[#bdeaff] bg-[#f3fbff] text-[#04044a]"}`}>
        ...
        <button type="button" onClick={() => window.print()} className={`flex items-center gap-1 rounded-lg border p-2 text-sm font-medium leading-4 ${theme === "dark" ? "border-[rgba(123,123,123,0.25)] bg-[#b0ff5e] text-[#181818]" : theme === "retro" ? "border-2 border-[#24252b] bg-[#ba0dcb] text-white shadow-[0_2px_0_#24252b]" : "border-[rgba(123,123,123,0.25)] bg-[#00a4ff] text-white"}`}>
