...
function Contract() { return <section className="rounded-2xl border border-cu-line p-5"><h2 className="text-lg font-semibold text-cu-ink">Public contract</h2><p className="mt-3 text-sm text-cu-muted"><code>children, align, className, typing, typingSpeed</code></p><p className="mt-2 text-sm text-cu-muted">Responsive scale: 48px mobile, 72px tablet, 96px desktop.</p></section>; }
