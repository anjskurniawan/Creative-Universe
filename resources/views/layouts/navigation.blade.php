<nav x-data="{ open: false }" class="border-b border-cu-line bg-cu-surface">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="border-t border-cu-line pb-1 pt-4">
            <div class="px-4">
                <div class="text-base font-medium text-cu-ink">{{ Auth::user()->name }}</div>
                <div class="text-sm font-medium text-cu-muted">{{ Auth::user()->email }}</div>
            </div>
