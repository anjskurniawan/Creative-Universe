            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="mt-2 text-sm text-cu-ink">
                        ...
                        <button form="send-verification" class="rounded-md text-sm text-cu-info underline hover:text-cu-info-hover focus:outline-none focus:ring-2 focus:ring-cu-focus focus:ring-offset-2">
