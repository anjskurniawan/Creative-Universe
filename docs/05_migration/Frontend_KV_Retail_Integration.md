...
Seluruh request domain KV Retail menggunakan `features/kv-retail/api` dan DTO `KvRetailTask`. Upload sementara kini membaca envelope backend `data.path` dengan benar. Pemilihan assignee hanya menampilkan pengguna yang memiliki assignment KV Retail.
